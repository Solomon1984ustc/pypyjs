...
.then(function() {
  return vm.eval("from time import sleep; sleep(1)")
}).then(function() {
  var test = [
...
.then(function(){
  //return vm.exec("from test import pystone; pystone.main()");
  gp = function () {
    console.log("1");
...
// .then(function() {
//   return vm.exec("from test import pystone; pystone.main(); pystone.main();pystone.main()");
// })
.then(function(){
  gp = function () {
    return new Promise(function (resolve, reject) {
